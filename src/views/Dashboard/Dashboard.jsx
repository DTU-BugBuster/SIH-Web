...
class Orissa extends React.Component {
  render() {
    return (
    <div style={{ marginTop: "-20px",marginLeft:"-10px", width: "95%" ,height:"10%"}}>
    <Card className="card-chart" style={{ marginTop: "0px",marginLeft:"0px", width: "98.7%" ,height:"1020%"}}>
      <CardHeader>
    ...
    return (
      <div>
        <PanelHeader
          ...
          <Row>
          <Col xs={12} md={8}>
            <Line style={{ marginTop: "-20px",marginLeft:"-10px", width: "95%" ,height:"100%"}}
